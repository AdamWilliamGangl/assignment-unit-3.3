...
console.log(supplyChanges); // Added so I could more easily check question 6
...
console.log('We filled', boxes, 'boxes of parts.');
console.log('The warehouse has', warehouse, 'parts remaining');